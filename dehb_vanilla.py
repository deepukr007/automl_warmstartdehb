...
if __name__ == '__main__':
    ...
    dehb = DEHB(f=objective_function, cs=cs, dimensions=dimensions, min_budget=min_epochs,
                max_budget=max_epochs, eta= eta, output_path=working_dir,n_workers=1  )
    ...
    acc = objective_function(incumbent, budget=100)
    dehb.logger.info("Test loss is {:.3f} for the best found configuration: ".format(acc["info"]["test_loss"]))
