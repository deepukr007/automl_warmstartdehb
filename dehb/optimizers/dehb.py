...
class DEHBBase:
    def __init__(self, cs=None, f=None, dimensions=None, mutation_factor=None,
                 ...
                 boundary_fix_type='random', max_age=np.inf, custom_initial_population=None, **kwargs):
        ...
        self.de_params = {
            ...
            "f": f,
            "custom_initial_population" :self.custom_initial_population
        }
...
class DEHB(DEHBBase):
    def __init__(self, cs=None, f=None, dimensions=None, mutation_factor=0.5,
                 ...
                 async_strategy="immediate", custom_initial_population=None, **kwargs):
        super().__init__(cs=cs, f=f, dimensions=dimensions, mutation_factor=mutation_factor,
                         ...
                         max_age=max_age, custom_initial_population=custom_initial_population, **kwargs)
    ...
    def init_population(self, pop_size):
        if self.configspace:
            population = []
            if self.custom_initial_population is not None:
                print("Custom population enter")
                population = self.custom_initial_population[:pop_size]
                self.custom_initial_population = self.custom_initial_population[pop_size:]
            if len(population) < pop_size:
                random_samples = self.cs.sample_configuration(size=pop_size-len(population))
            ...
            raise Exception("we are only working with configspaces")
