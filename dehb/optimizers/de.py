...
class DEBase():
    ...
    def __init__(self, cs=None, f=None, dimensions=None, pop_size=None, max_age=None,
                 ...
                 boundary_fix_type='random', custom_initial_population=None, **kwargs):
    ...
    def init_population(self, pop_size: int) -> List:
        if self.configspace:
            ...
            if self.custom_initial_population is not None:
                # use samples from the custom population as long as some are left
...
class DE(DEBase):
    def __init__(self, cs=None, f=None, dimensions=None, pop_size=20, max_age=np.inf,
                 ...
                 budget=None, encoding=False, dim_map=None, custom_initial_population=None, **kwargs):
        super().__init__(cs=cs, f=f, dimensions=dimensions, pop_size=pop_size, max_age=max_age,
                         ...
                         strategy=strategy, budget=budget, custom_initial_population=custom_initial_population, **kwargs)
